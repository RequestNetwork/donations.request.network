...
var requestContractAddressRinkeby = '0xd88ab9b1691340E04a5BBf78529c11d592d35f57',
    requestContractAddressMainnet = '0x7b3C4D90e8AF6030d66c07F8F815f9505E379d6F';
...
function requestNetworkDonations(opts) {
    ...
    this.generateQrCode = function () {
        ...
        var qr = new RequestQRCode({
            value: 'ethereum:' + that.getRequestContractAddress() + '?amount=' + totalOwed + '&data=' + transactionData,
            background: '#f5f6fa',
            size: 300
        });
    ...
    this.addClickEvents = function () {
        ...
        ledgerButton.addEventListener('click', function () {
            ...
            var gasPriceInWei = web3.toWei('30', 'gwei');
    ...
    this.getCurrencyAddress = function (currency) {
        ...
        return allContractAddresses[currency].main;
    }
    ...
    this.fetchArtifactInfo = function () {
